...
var ytApi_1 = require("../service/ytApi");
var UserApi_1 = require("../service/UserApi");
var ApiHandlers = /** @class */ (function () {
    function ApiHandlers() {
    }
    ApiHandlers.prototype.ytApiHandlers = function () {
        var _this = this;
        electron_1.ipcMain.handle('search', function (event, args) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ytApi_1.default.getInfo(args.url)];
    ...
    ApiHandlers.prototype.userApiHandlers = function () {
        var _this = this;
        electron_1.ipcMain.handle('savePath', function (event, args) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        electron_1.ipcMain.handle('getUserConfig', function (event, args) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, UserApi_1.default.getUserConfig()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); });
        ...
        electron_1.ipcMain.handle('deleteItem', function (event, args) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, UserApi_1.default.deleteItem(args)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); });
...
exports.default = new ApiHandlers();
