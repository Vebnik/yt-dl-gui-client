...
var YtApi = /** @class */ (function () {
    ...
    YtApi.prototype.streamDownload = function (videoInfo, config, Video) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.checkFFmpeg()];
                    case 1:
                        if (!(_a.sent()))
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, (0, ytdl_core_1.downloadFromInfo)(videoInfo, { quality: 'highestaudio' })
    ...
    YtApi.prototype.checkFFmpeg = function () {
        return __awaiter(this, void 0, void 0, function () {
            var check;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        check = new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, cp.spawn('ffmpeg').on('error', function (err) { return resolve(false); })];
                                    case 1:
                                        _a.sent();
                        ...
                        return [4 /*yield*/, Promise.all([check])];
                    case 1:
                        _a.sent();
